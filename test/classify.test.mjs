...
const cases = [
  ...
  [['BJ', 'RJ', 'BJ', 'RJ'], '2', 'jokerBomb', 100, 'joker bomb (2 big + 2 small)'],
  [['RJ', 'RJ'], '2', 'pair', 17, 'pair of big jokers'],
  [['BJ', 'BJ', 'BJ'], '2', 'triple', 16, 'triple of small jokers (3-deck)'],
  [['RJ', 'RJ', 'RJ'], '2', 'triple', 17, 'triple of big jokers (3-deck)'],
  [['RJ', 'RJ', 'RJ', 'S5', 'H5'], '2', 'hung', 17, 'hung: 3 big jokers over pair of 5s'],
  [['S5', 'H5', 'D5', 'RJ', 'RJ'], '2', 'hung', 5, 'hung: triple 5s over pair of big jokers'],
  [['BJ', 'RJ'], '2', 'unknown', null, 'big+small joker is NOT a pair (different ranks)'],
