...
const cases = [
  ...
  [['S3', 'S4', 'S5', 'S6', 'S7'], '2', 'straightFlush', null, 'straight flush'],
  [['S5','H5','S6','H6','S7','H7'], '2', 'tube', null, 'tube'],
  [['S5','H5','D5','S6','H6','D6'], '2', 'plate', null, 'plate'],
  [['S5','H5','D5','S6','H6'], '2', 'fullHouse', 5, 'full house'],
